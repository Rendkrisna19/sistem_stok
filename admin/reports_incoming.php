        ...
        <div id="page-content-wrapper">
            ...
            <div class="main-content-area">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form id="reportFilterForm" method="GET" action="<?= BASE_URL ?>/admin/reports_incoming.php">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped" id="incomingReportTable" width="100%"
                                cellspacing="0">
                                <thead>
                                    <tr>
                                        <th>No.</th>
