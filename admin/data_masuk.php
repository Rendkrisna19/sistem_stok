...
// Catatan: Menghapus transaksi历史 biasanya membutuhkan logika yang kompleks
// karena harus mengembalikan stok barang ke kondisi semula.
// Untuk kemudahan demo, ini adalah hapus sederhana. Di sistem nyata, perlu logika rollback stok.
if (isset($_GET['action']) && $_GET['action'] == 'delete' && isset($_GET['id'])) {
    ...
    try {
        ...
        $stmt_get_trans = $pdo->prepare("SELECT item_id, quantity FROM transactions WHERE id = ? AND transaction_type = 'incoming'");
        ...
        if ($transaction_data) {
            ...
            // 3. Kembalikan stok barang (kurangi stok karena ini transaksi masuk yang dihapus)
            ...
            $pdo->commit();
            $success_message = 'Transaksi barang masuk berhasil dihapus dan stok dikembalikan.';
            redirect(BASE_URL . '/admin/data_masuk.php?msg=deleted');
        } else {
            $error_message = 'Transaksi tidak ditemukan atau bukan transaksi masuk.';
            redirect(BASE_URL . '/admin/data_masuk.php?msg=error_delete');
        }
...
if (isset($_GET['msg'])) {
    if ($_GET['msg'] == 'added') { // Jika redirect dari form input barang masuk
        $success_message = 'Data barang masuk berhasil disimpan.';
    } elseif ($_GET['msg'] == 'deleted') {
        $success_message = 'Transaksi barang masuk berhasil dihapus.';
...
<head>
    ...
    <title>Data Barang Masuk - Admin</title>
...
<body>
            ...
            <div class="main-content-area">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Daftar Transaksi Barang Masuk</h6>
                        <a href="<?= BASE_URL ?>/admin/transactions.php" class="btn btn-primary btn-sm">
                            <i class="fas fa-plus"></i> Entri Data Baru
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped" id="incomingTransactionsTable"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="7" class="text-center">Tidak ada data transaksi barang masuk.</td>
                                    </tr>
                                    <?php else: ?>
                                    <?php $counter = 1; ?>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        $('#incomingTransactionsTable').DataTable({
            "language": {
